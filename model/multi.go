...
func NewMulti(c *MultiConfig) *MultiLayer {
	// size
...
func (m *MultiLayer) Predict(x matrix.Matrix) matrix.Matrix {
...
func (m *MultiLayer) Loss(x, t matrix.Matrix) matrix.Matrix {
	y := m.Predict(x)
...
func (m *MultiLayer) Gradient(x, t matrix.Matrix) map[string]matrix.Matrix {
	// forward
	m.Loss(x, t)
...
func (m *MultiLayer) NumericalGradient(x, t matrix.Matrix) map[string]matrix.Matrix {
...
func (m *MultiLayer) Optimize(grads map[string]matrix.Matrix) {
